...
/**
 *	Make the room publically joinable
 * 
 * @return {Promise} A promise will be returned which will resolve once then room is made public
 */
p.setPublic = function() {

	return this.memory.setRoomPublic( this.id );
};

/**
 *	Make the room private
 * 
 * @return {Promise} A promise will be returned which will resolve once then room is made private
 */
p.setPrivate = function() {

	return this.memory.setRoomPrivate( this.id );
};
