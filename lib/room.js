...
room.prototype = {
	 ...
	 * @return {Promise} A promise will be returned which will resolve once then variable is deleted
	 */
	deleteVar: function( key ) {

		if( this.roomData[ key ] !== undefined ) {
	...
	setRoomData: function( data ) {
		...
		return this.memory.setRoomData( this.id, this.roomData );
	},
